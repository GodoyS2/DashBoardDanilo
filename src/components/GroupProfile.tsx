...
const GroupProfile: React.FC<GroupProfileProps> = ({ group, onClose, onManageMembers }) => {
            ...
            <div className="sm:flex sm:items-start">
              <div className="w-full">
                ...
                <div className="flex flex-col items-center mb-6">
                  ...
                  {group.description && (
                    <p className="mt-2 text-gray-600 text-center">{group.description}</p>
                  )}
                </div>
                ...
                <div className="space-y-4">
                  <div className="border-t border-b border-gray-200 py-4">
                    ...
                    {groupMembers.length === 0 ? (
                      <p className="text-gray-500 text-sm italic">Nenhum membro neste grupo</p>
                    ) : (
