...
CREATE POLICY "Enable delete for authenticated users" ON public.people
...
CREATE POLICY "Enable insert for authenticated users" ON public.locations
  FOR INSERT TO authenticated WITH CHECK (true);

CREATE POLICY "Enable update for authenticated users" ON public.locations
  FOR UPDATE TO authenticated USING (true);

CREATE POLICY "Enable delete for authenticated users" ON public.locations
  FOR DELETE TO authenticated USING (true);

-- Create policies for location_assignments table
CREATE POLICY "Enable read access for authenticated users" ON public.location_assignments
  FOR SELECT TO authenticated USING (true);

CREATE POLICY "Enable insert for authenticated users" ON public.location_assignments
  FOR INSERT TO authenticated WITH CHECK (true);

CREATE POLICY "Enable update for authenticated users" ON public.location_assignments
  FOR UPDATE TO authenticated USING (true);

CREATE POLICY "Enable delete for authenticated users" ON public.location_assignments
  FOR DELETE TO authenticated USING (true);
